-- Fix type_of_record column data type and nullability (handling view dependency)
-- Run this on Supabase SQL Editor

-- First, let's check what views depend on this table
SELECT 
    viewname,
    schemaname
FROM pg_views 
WHERE schemaname = 'public' 
AND viewname LIKE '%entity%';
...
-- Drop the view if it exists (we'll recreate it later)
...
-- Test the view
SELECT COUNT(*) as view_record_count FROM entity_relationships_view; 