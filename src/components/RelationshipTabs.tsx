...
export default function RelationshipTabs({ currentTable, currentId, relatedData }: RelationshipTabsProps) {
  ...
  return (
    <Tabs defaultValue={children[0]?.table || "parent"} className="w-full flex flex-row gap-6">
      {/* Vertical TabsList */}
      <TabsList className="flex flex-col w-56 min-w-[180px] max-w-xs items-stretch mr-6">
        {parent && (
